      ...
      {type === "artist" && (
        <>
          <button
            ...
            className={`${btnClass} ${!isArtistsFollowed ? 'text-[#1ed760] hover:text-[#1fdf64]' : 'text-red-400 hover:text-red-300'}`}
          >
            {!isArtistsFollowed ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                       strokeWidth="2"
                                       stroke="currentColor"
                                       className={`w-5 h-5 ${isArtistsFollowed ? 'text-[#1ed760]' : 'text-neutral-400 group-hover:text-white'}`}>
            ...
            </svg> : <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.8"
