...
function EditInfo() {
  ...
  const currentAvatar =
    user?.user_metadata?.avatar_url || "/profileImg.png";

  return (
    <div className="max-w-xl w-full mx-auto px-4 my-auto py-8 flex flex-col gap-y-6">
      ...
      <div className="bg-[#181818] border border-[#262626]  my-auto rounded-2xl p-6 sm:p-8 shadow-xl relative overflow-hidden">
