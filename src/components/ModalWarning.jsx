...
function ModalWarning({ onClose , isOpen }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="w-full max-w-md rounded-2xl bg-[#121212] border border-white/10 overflow-hidden">
        ...
        <div className="flex gap-2 p-5 bg-[#181818] border-t border-white/5">
          <button
            onClick={onClose}
          ...
          <Button wherePage="/login" color="bg-[#1DB954]"
