    ...
    <div className="flex items-center justify-end gap-1 select-none">
      ...
      {onDelete && (
        <button
          type="button"
          onClick={onDelete}
          className="p-2 text-gray-400 hover:text-red-500 active:text-red-600 active:scale-90 rounded-full hover:bg-white/5 transition-all duration-150 shrink-0 cursor-pointer"
          title={deleteTitle}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
